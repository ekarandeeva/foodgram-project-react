...
Установить на сервере docker и docker-compose. Скопировать на сервер файлы docker-compose.yml и nginx.conf:
...
Клонировать репозиторий и перейти по командной строке:

``` git@github.com:ekarandeeva/foodgram-project-react.git ``` 
``` cd infra ``` 
...
Клонировать репозиторий и перейти в него по командной строке:
